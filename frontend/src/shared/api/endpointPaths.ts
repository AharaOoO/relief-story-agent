export const endpointPaths = {
  ...
  runRenderPlan: (runId: string) => `/api/runs/${runId}/render-plan`,
  runSegment: (runId: string, segmentId: string) => `/api/runs/${runId}/segments/${segmentId}`,
  runSegmentRetryImage: (runId: string, segmentId: string) => `/api/runs/${runId}/segments/${segmentId}/retry-image`,
  runSegmentRetryVideo: (runId: string, segmentId: string) => `/api/runs/${runId}/segments/${segmentId}/retry-video`,
  runSegmentCancel: (runId: string, segmentId: string) => `/api/runs/${runId}/segments/${segmentId}/cancel`,
  runAssemble: (runId: string) => `/api/runs/${runId}/assemble`,
